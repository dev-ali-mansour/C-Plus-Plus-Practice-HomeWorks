...
public:
    ...
    void LoadDatabase() {
        ...
        vector<string> lines = ReadFileLines(R"(/home/alimansour/Training/C++Course/HomeWorks/ASkMe-OOP/questions.txt)");
        for (const auto &line : lines) {
...
public:
    ...
    void LoadDatabase() {
        ...
        vector<string> lines = ReadFileLines(R"(/home/alimansour/Training/C++Course/HomeWorks/ASkMe-OOP/users.txt)");
        for (const auto &line : lines) {
            User user(line);
